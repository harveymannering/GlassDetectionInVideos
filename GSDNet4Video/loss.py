...
class ReflectionLoss(nn.Module):
    ...
    def forward(self, d0, d1, d2, d3, d4, r_glass, r_global, ground_truth):
        # Parmaeters:
        ...
        loss += weights[1] * lovasz_hinge(d0, ground_truth, True)
        loss += weights[2] * lovasz_hinge(d1, ground_truth, True)
        loss += weights[3] * lovasz_hinge(d2, ground_truth, True)
        loss += weights[4] * lovasz_hinge(d3, ground_truth, True)
        loss += weights[5] * lovasz_hinge(d4, ground_truth, True)
